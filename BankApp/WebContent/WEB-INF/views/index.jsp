	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="jumbotron">
					<h1 class="display-4">Welcome to Royal Bank</h1>
					<p class="lead">Hapiness = A Good Bank Account, A Good Cook and
						a Good Digestion -Jean</p>
					<a href="user/new" class="btn btn-lg btn-success">Register
						Here</a>
					<p>
						or<br /> <a href="user/login">Existing user</a>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-3 col-lg-3 col-md-3 col-sm-6 col-12">
